    ...
    <c:choose>
        <c:when test="${room.id!=0}">
            <h3 class="cred-header">
                <span class="cred-title"><spring:message code="room.edit"/></span>
                <span class="cred-name">[${room.name}]</span>
            </h3>
        </c:when>
        <c:otherwise>
            <h3 class="cred-header">
                <span class="cred-title"><spring:message code="room.create"/></span>
            </h3>
        </c:otherwise>
    </c:choose>
    <div class="tabbable">
        ...
        <div class="tab-content">
            <form id="form" accept-charset="UTF-8" action="${action}" method="POST">
                <form:hidden id="room_id" path="room.id"/>
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <c:set var="varName" value="room.name"/>
                        ...
                        <div class="form-group">
                            <c:set var="varName" value="room.tableLenght"/>
                            <form:label path="${varName}" cssClass="control-label">
                                <spring:message code="${varName}"/>
                                <span class="symbol required"></span>
                                <form:errors cssClass="form-validation-error" path="${varName}"/>
                        ...
                        <div class="form-group">
                            <c:set var="varName" value="room.tableWidth"/>
                            <form:label path="${varName}" cssClass="control-label">
                                <spring:message code="${varName}"/>
                                <span class="symbol required"></span>
                                <form:errors cssClass="form-validation-error" path="${varName}"/>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <c:set var="varName" value="room.roomType"/>
                            <form:label path="${varName}" cssClass="control-label">
                                <spring:message code="${varName}"/>
                                <span class="symbol required"></span>
                                <form:errors cssClass="form-validation-error" path="${varName}"/>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <c:set var="varName" value="room.descriptions"/>
                            <form:label path="${varName}" cssClass="control-label">
                                <spring:message code="${varName}"/>
                                <span class="symbol required"></span>
                                <form:errors cssClass="form-validation-error" path="${varName}"/>
