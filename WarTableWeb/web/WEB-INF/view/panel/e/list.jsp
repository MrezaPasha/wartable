...
<div class="container" style="min-height: 300px;">
    <div class="page-header">
        <div class="cred-header">
            <h3 class="cred-title"><spring:message code="irror.list"/></h3>
        </div>
    </div>
    <div class="row">
        <div ir-search-id="adv1" ir-search-url="${cp}/panel/e/list" ir-search-auto-submit="true"
             class="lix-container">
