...
<div class="container c-list-container">
    <div class="page-header">
        <div class="cred-header">
            <h3 class="cred-title"><spring:message code="T.p.service.room.chat.conversation"/></h3>
            <span class="cred-name">[${room.name}]</span>
            <a href="${_url}/list" class="btn btn-p-back btn-animated btn-animated-right">
                <i class="fa fa-reply"></i>
                <span class="title"><spring:message code="T.p.service.room.list"/></span>
            </a>
        </div>
                ...
                <c:when test="${not empty clist}">
                    <ul class="columns">
                        <c:forEach items="${clist}" var="myvar">
                            <li>
                                <a href="${_url}/chat/details/${myvar.id}">
                                    <div class="timeline_element">
                                        ...
                                        <div class="readmore">
                                            <span class="timeline-receiver-title"><spring:message code="textChat.receivers"/></span>
                                            <C:forEach items="${myvar.receivers}" var="res">
                                                <span class="timeline-receiver">${res.fullName}</span>
                                            </C:forEach>
                                        </div>
                                    </div>
                                </a>
