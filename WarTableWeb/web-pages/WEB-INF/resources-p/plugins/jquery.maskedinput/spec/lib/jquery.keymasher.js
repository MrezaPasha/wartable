...
(function ($, undefined) {
    ...
    var keys = (function () {
        var defs = {},
            ...
            noprint = {
                shift: 16, ctrl: 17, meta: 91, alt: 18, f1: 112, f2: 113, f3: 114, f4: 115, f5: 116, f6: 117, f7: 118, f8: 119, f9: 120, f10: 121, f11: 122, f12: 123,
        ...
        $.each(noprint, function (key, value) {
            defs[key] = {keyCode: value};
        });
        return defs;
    })();
        ...
        var public = {
            hold: function (holding, typing) {
                ...
                $.each(toks, function (index, value) {
                    queueModifierEvent('down', value);
                });
                public.type(typing);
                $.each(toks, function (index, value) {
                    queueModifierEvent('up', value);
                });
                return public;
            },
            type: function () {
                $.each(arguments, function (index, typing) {
                    if ($.type(typing) === 'string')
                        $.each(typing.split(''), function (index, value) {
                            queueStroke(value);
                        });
                    else
                        queueStroke(typing);
