                                        ...
                                        <tr>
                                            ...
                                            <td class="center">
                                                <div class="visible-md visible-lg hidden-sm hidden-xs  r-button">
                                                    <a href="${cp}/panel/user/porter/details/${user.id}/${myvar.id}"
                                                       class="btn btn-sm btn-l-details tooltips " data-placement="top"
                                                       data-original-title="جزئیات">
                                                        <i class="clip-flickr"></i>
                                                    </a>
                                                    <a href="${cp}/panel/user/porter/unconfirm/${user.id}/${myvar.id}"
...
<script type="text/javascript"
        src="${cp}/resources-p/plugins/dataTables/media/js/jquery.dataTables.js?r=${rl2}"></script>
