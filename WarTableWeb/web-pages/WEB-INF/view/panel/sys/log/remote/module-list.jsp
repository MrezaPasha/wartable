...
<div class="container module-list">
    <div class="page-header">
        <h3 class="cred-header">
            <span class="cred-title"><spring:message code="T.p.sys.log.remote.moduleList"/></span>
        </h3>
    </div>
                ...
                <table class="table dataTable table-striped table-hover" id="table_list_x" data-sort-index="0" data-sort-type="asc" data-display-len="-1">
                    ...
                    <c:forEach items="${mlist}" var="myvar">
                        <tr>
                            ...
                            <td>
                                <c:forEach items="${myvar.tasks}" var="tsk">
                                    <c:if test="${tsk.isSuperAdmin==false}">
                                        <a href="${_url}/task/config/${tsk.id}" class="task-item-log <c:if test="${tsk.isOnlineLogging}">online-logging</c:if>">
                            ...
                            <td>
                                    <%--<a href="${_url}/list/${myvar.id}" class="btn btn-sm btn-l-level tooltips " data-placement="top" data-original-title="<spring:message code="task.list" />">--%>
