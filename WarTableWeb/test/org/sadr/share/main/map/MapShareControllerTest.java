...
public class MapShareControllerTest extends AbstractContextControllerTests {
    ...
    public void pListTest_accessTo() throws Exception {
        ...
        this.mockMvc
                ...
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(view().name(TtTile___.p_service_map_list.getCode()))
                .andExpect(model().hasNoErrors())
    ...
    public void pCreateTest_accessTo() throws Exception {
        ...
        this.mockMvc
                ...
                .andExpect(view().name(TtTile___.p_e_401.getCode()))
                .andExpect(model().hasNoErrors())
                .andExpect(model().attributeDoesNotExist("map", "action"))
        ;
        ...
        this.mockMvc
                ...
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(view().name(TtTile___.p_service_map_create.getCode()))
                .andExpect(model().hasNoErrors())
                .andExpect(model().attributeExists("map", "action"))
        ;
    }
    //............................. pCreateTest_accessTo  #
    ...
    public void pCreateTest_post_submit() throws Exception {
        Map objMap = MockObjectInstances.getInstance().getMap(true);

        //----------------------- Check Access
        this.mockMvc
                .perform(
                        MockObjectBuilder
                                .postForm(_PANEL_URL + "/create", objMap)
                                .session(session)
                )
                .andDo(print())
                .andExpect(status().isOk())
    ...
    public void pEditTest_accessTo() throws Exception {
        ...
        Map realMap = MockObjectInstances.getInstance().getRealMap();

        //----------------------- LogManager
        this.signinAsLogManager();
        this.mockMvc
                .perform(
                        get(_PANEL_URL + "/edit/" + realMap.getId())
                                .session(session)
                                .accept(MediaType.TEXT_HTML)
                )
                .andDo(print())
        ...
        this.mockMvc
                ...
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(view().name(TtTile___.p_service_map_edit.getCode()))
                .andExpect(model().hasNoErrors())
                .andExpect(model().attributeExists("map", "action"))
        ;
    }
    ...
    public void pEditTest_post_submit() throws Exception {
        ...
        this.mockMvc
                .perform(
                        MockObjectBuilder
                                .postForm(_PANEL_URL + "/edit", MockObjectInstances.getInstance().getMap(true))
                                .session(session)
                )
                .andDo(print())
                .andExpect(status().isOk())
        ...
        this.mockMvc
                .perform(
                        MockObjectBuilder
                                .postForm(_PANEL_URL + "/edit", realMap)
                                .session(session)
                )
                .andDo(print())
                .andExpect(status().isFound())
        ...
        this.mockMvc
                ...
                .andDo(print())
                .andExpect(status().isFound())
                .andExpect(flash().attributeExists("notice", "map"))
        ;
    }
    //............................. pEditTest_post_submit  #
    ...
    public void pTrashTest_ajax_do() throws Exception {
        ...
        MvcResult mvcResult = this.mockMvc
                .perform(
                        MockObjectBuilder
                                .postForm(_PANEL_URL + "/create", MockObjectInstances.getInstance().getMap(true))
                                .session(session)
                )
                .andDo(print())
                .andExpect(status().isFound())
    ...
    //#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=# pRoomListTest  #
    //============================= pRoomListTest_accessTo  #
    @Test
    public void pRoomListTest_accessTo() throws Exception {
        //--- EMPTY_TEST 
    ...
    //#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=# pRoomEditTest  #
    //============================= pRoomEditTest_accessTo  #
    @Test
    public void pRoomEditTest_accessTo() throws Exception {
        //--- EMPTY_TEST 
    ...
    //#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=# pRoomTrashTest  #
    //============================= pRoomTrashTest_accessTo  #
    @Test
    public void pRoomTrashTest_accessTo() throws Exception {
        //--- EMPTY_TEST 
    ...
    //#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=# pRoomCreateTest  #
    //============================= pRoomCreateTest_accessTo  #
    @Test
    public void pRoomCreateTest_accessTo() throws Exception {
        //--- EMPTY_TEST 
