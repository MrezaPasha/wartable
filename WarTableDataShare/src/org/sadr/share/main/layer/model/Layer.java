...
public class Layer implements Serializable {
    ...
    public Layer(int id, String name, String type, int samplesWidth, int samplesHeight, int tileCountHorz, int tileCountVert, List<Double> bounds, int minHeight, int maxHeight, double spacingHorz, double spacingVert, int spacingHeight) {
        id = id;
        Name = name;
        Type = type;
