...
<div class="container module-list">
    <div class="page-header">
        <h3 class="cred-header">
            <span class="cred-title"><spring:message code="T.p.sys.module.listConfirm"/></span>
        </h3>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <c:forEach items="${myvar.tasks}" var="tsk">
                                    <c:if test="${tsk.isSuperAdmin==false && tsk.isAjax==false}">
                                                <span title="${tsk.url}" class="task-item <c:if test="${!tsk.isTwoLevelConfirm}">inactive</c:if> ">
                                                        ${tsk.fullTitle}
                                                </span>
                                    </c:if>
                                </c:forEach>
