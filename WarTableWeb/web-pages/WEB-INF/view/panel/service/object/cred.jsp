...
<div class="container">
    <c:choose>
        <c:when test="${object.id!=0}">
            <h3 class="cred-header">
                <span class="cred-title"><spring:message code="T.p.service.object.edit"/></span>
                <span class="cred-name">[${object.name}]</span>
            </h3>
        </c:when>
        <c:otherwise>
            <h3 class="cred-header">
                <span class="cred-title"><spring:message code="T.p.service.object.create"/></span>
            </h3>
        </c:otherwise>
    </c:choose>
    <div class="tabbable">
