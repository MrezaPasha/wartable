...
<div class="container">
    <c:choose>
        <c:when test="${baseErrors.id!=0}">
            <h3 class="cred-header">
                <span class="cred-title"><spring:message code="baseErrors.edit"/></span>
                <span class="cred-name">[${baseErrors.errorId}]</span>
            </h3>
        </c:when>
        <c:otherwise>
            <h3 class="cred-header">
                <span class="cred-title"><spring:message code="baseErrors.create"/></span>
            </h3>
        </c:otherwise>
    </c:choose>
    <div class="tabbable">
