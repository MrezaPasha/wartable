...
<div class="container">
    <div class="page-header">
        <h3 class="cred-header">
            <span class="cred-title" ><spring:message code="log.task.online.logging" /></span>
            <div class="cred-name">
    ...
    <div class="input-group well col-xs-12  padding-scope" >
        ...
        <ul class="disabled-li margin-bottom xs-center-ul" >
            <li class="tooltips" data-original-title="<spring:message  code="module.list"/>" data-placement="bottom">
                <a  href="${cp}/panel/log/module/list" class="btn btn-default btn-block">
                    <i class="fa fa-list"></i>
                    <span class="title"></span>
                </a>
            </li>
            <li class="tooltips" data-original-title=" <spring:message code="all.reload"/>" data-placement="bottom">
                <a href="${cp}/panel/log/task/online/logging/${taskViewModel.moduleId}" class="btn btn-default btn-block">
