...
public class SigninLogControllerTest extends AbstractContextControllerTests {

    ////////////////////
    private final String _PANEL_URL = "/panel/log/signin";
    ...
    public void pListTest_accessTo() throws Exception {
        ...
        this.mockMvc
                ...
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(view().name(TtTile___.p_sys_log_signin_list.getCode()))
                .andExpect(model().hasNoErrors())
