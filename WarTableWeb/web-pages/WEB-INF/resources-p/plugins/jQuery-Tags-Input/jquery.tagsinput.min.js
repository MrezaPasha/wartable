(function (a) {
    ...
    a.fn.tagsInput = function (d) {
        var e = jQuery.extend({interactive: true, defaultText: "افزودن برچسب", minChars: 0, width: "300px", height: "100px", autocomplete: {selectFirst: false}, hide: true, delimiter: ",", unique: true, removeWithBackspace: true, placeholderColor: "#666666", autosize: true, comfortZone: 20, inputPadding: 6 * 2}, d);
        this.each(function () {
            if (e.hide) {
                a(this).hide()
            }
