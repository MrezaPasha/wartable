...
<div class="container c-list-container">
    <div class="page-header">
        <div class="cred-header">
            ...
            <a href="${_url}/list/inactive" class="btn btn-p-choice btn-animated btn-animated-right">
                <i class="clip-deviantart light"></i>
                <span class="title"><spring:message code="user.list.inactive"/></span>
            </a>
            <a href="${_url}/list/online" class="btn btn-p-amar btn-animated btn-animated-right">
                                    ...
                                    <td class="center">
                                        <div class="r-button">
                                            <a href="@{plugin_masterLink}@{id}"
                                               class="btn btn-sm @{plugin_masterClass}" data-placement="top"
                                               title="<spring:message code="user.level"/>">
                                            ...
                                            <a href="javascript:void(0)" class="btn btn-sm btn-bricky"
                                               ...
                                               i-search-body-item-trash-title="@{fullName}"
                                               i-search-body-item-trash-url=""
    ...
    jQuery(document).ready(function () {
        pluginFillBody = function (i, value, newItem) {
            if (value.isMaster && !value.isLogManager) {
                ...
                newItem = newItem.replace(new RegExp("@{plugin_masterLink}", "g"), "${_url}/access/list/");
            } else {
