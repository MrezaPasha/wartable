...
<div class="container">
    <c:choose>
        <c:when test="${meeting.id!=0}">
            <h3 class="cred-header">
                <span class="cred-title"><spring:message code="T.p.service.meeting.edit"/></span>
                <span class="cred-name">[${meeting.name}]</span>
            </h3>
        </c:when>
        <c:otherwise>
            <h3 class="cred-header">
                <span class="cred-title"><spring:message code="T.p.service.meeting.create"/></span>
            </h3>
        </c:otherwise>
    </c:choose>
    <div class="tabbable">
        ...
        <div class="tab-content">
            <form id="form" accept-charset="UTF-8" action="${action}" method="POST">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <c:set var="varName" value="meeting.goal"/>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <c:set var="varName" value="meeting.room"/>
                            <form:label path="${varName}" cssClass="control-label">
                                <spring:message code="${varName}"/>
                                <span class="symbol required"></span>
                                <form:errors cssClass="form-validation-error" path="${varName}"/>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <c:set var="varName" value="meeting.description"/>
                            <form:label path="${varName}" cssClass="control-label">
                                <spring:message code="${varName}"/>
                                <span class="symbol required"></span>
                                <form:errors cssClass="form-validation-error" path="${varName}"/>
