...
<div class="container print">
    ...
    <div class="tabbable">
        <div class=" col-xs-12 padding-scope data-form" >
            <form id="form" accept-charset="UTF-8" action="${cp}/panel/user/group/desk" method="POST">
                <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td class="right btn-tools" style="width: 168px;">
                                        <div class="visible-md visible-lg hidden-sm hidden-xs operation-icon">
                                            <a  href="${cp}/panel/user/group/assign/${myvar.id}" class="btn btn-sm btn-l-assign tooltips" data-placement="top" data-original-title="<spring:message code="users.userGroup.assign"/>">
                                                <i class="clip-stack-empty"></i>
                                            </a>
                                            <a  href="${cp}/panel/user/group/desk?ix=${myvar.id}" class="btn btn-sm btn-l-edit tooltips" data-placement="top" data-original-title="<spring:message code="all.edit"/> ">
                                                <i class="fa fa-edit  pad-2"></i>
                                            </a>

                                            <a  href="${cp}/panel/user/group/access/list/${myvar.id}" class="btn btn-sm btn-l-level tooltips" data-placement="top" data-original-title="<spring:message code="users.userGroup.level"/> ">
                                        ...
                                        <div class="visible-xs visible-sm hidden-md hidden-lg r-button">
                                            <div class="btn-group">
                                                ...
                                                <ul role="menu" class="dropdown-menu pull-right "  style="z-index: 1000;">
                                                    ...
                                                    <li role="presentation">
                                                        <a role="menuitem" tabindex="-1" href="${cp}/panel/user/group/desk?ix=${myvar.id}">
                                                            <i class="fa fa-edit  pad-2"></i>
                                                            <spring:message code="all.edit"/>
                                                        </a>
                                                    </li>
                                                    <li role="presentation">
                                                        <a role="menuitem" tabindex="-1" href="${cp}/panel/user/group/assign/list/${myvar.id}">
                                                            <i class="fa fa-shield  pad-2"></i>
