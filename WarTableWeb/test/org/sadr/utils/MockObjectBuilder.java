...
public class MockObjectBuilder {
    ...
    private static final Log logger = LogFactory.getLog(MockObjectBuilder.class);

    private MockObjectBuilder() {
    }
...
//                    OutLog.p(field.getName() + "  " + field.getType() + "   " + field.isAnnotationPresent(ManyToOne.class));
...
//                }
    ...
    private static Map<String, String> getCollectionFields(Iterable<?> iterable, String path, Field field) {
        ...
        for (Object object : iterable) {
            ...
            OutLog.p(getPositionedField(path, field, i) + "   " + getStringValue(object));
            i++;
        }
        return fields;
    }
