...
<div class="container" style="min-height: 300px;">
    <div class="page-header">
        <div class="cred-header">
            <h3 class="cred-title"><spring:message code="log.list"/></h3>
        </div>
    </div>
    <div class="row">
        <div ir-search-id="adv1" ir-search-url="${cp}/panel/log/remote/list" ir-search-auto-submit="true"
             class="lix-container">
                        ...
                        <div ir-search-body-template="table" class="margin-b-10 ir-search-list table-responsive">
                            <table>
                                ...
                                <tr ir-search-body-item>
                                    ...
                                    <td class="center">
                                        <div class="r-button">
                                            <a href="${cp}/panel/log/remote/details/@{id}"
