...
<div class="container c-list-container">
    <div class="page-header">
        <div class="cred-header">
            ...
            <h3 class="cred-title"><spring:message code="T.p.service.map.room.list"/></h3>
            <span class="cred-name">[${map.name}]</span>
            <a href="${_url}/room/create/${map.id}" class="btn btn-p-create btn-animated btn-animated-right">
                <i class="clip-plus-circle light"></i>
                <span class="title"><spring:message code="map.room.create"/></span>
            </a>
        </div>
    </div>
    <div class="row">
        <div class="c-search-container"
             ...
             i-search-opt-url="${_url}/room/list"
