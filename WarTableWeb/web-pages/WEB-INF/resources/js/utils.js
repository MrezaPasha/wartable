...
+function (a) {
    ...
    c.VERSION = "2.2.0", c.DEFAULTS = {off: "خیر", on: "بله", onstyle: "primary", offstyle: "default", size: "small", width: null, height: null}, c.prototype.defaults = function () {
        ...
        return {
            on: this.$element.attr("data-on") || c.DEFAULTS.on, off: this.$element.attr("data-off") || c.DEFAULTS.off,
            onstyle: this.$element.attr("data-onstyle") || c.DEFAULTS.onstyle,
            offstyle: this.$element.attr("data-offstyle") || c.DEFAULTS.offstyle,
            size: this.$element.attr("data-size") || c.DEFAULTS.size,
            style: this.$element.attr("data-style") || c.DEFAULTS.style,
        ...
        var b = "large" === this.options.size ? "btn-lg" : "small" === this.options.size ? "btn-sm" : "mini" === this.options.size ? "btn-xs" : "", c = a('<div class="btn">').html(this.options.on).addClass(this._onstyle + " " + b),
            d = a('<div class="btn">').html(this.options.off).addClass(this._offstyle + " " + b + " active"), e = a('<span class="toggle-handle btn btn-default">').addClass(b), f = a('<div class="toggle-group">').append(c, d, e),
