    ...
    if (window.Select2 === b) {
        ...
        j = a(document), g = function () {
            ...
            i.x = a.pageX, i.y = a.pageY
                ...
                if ($(c).hasClass("select2-selected")) {
                this.close();
                } else {
                ...
                if (c = a.data("select2-data")) {
                    for (; (d = o(this.id(c), b)) >= 0; )
                        b.splice(d, 1), this.setVal(b), this.select && this.postprocessResults();
            ...
            return this.each(function () {
                ...
                var c = b - a.length;
                return " لطفا بیش از" + c + "کاراکتر وارد نمایید ";
            }, formatInputTooLong: function (a, b) {
                var c = a.length - b;
                return " لطفا" + c + " کاراکتر را حذف کنید.";
            }, formatSelectionTooBig: function (a) {
                return "شما فقط می‌توانید " + a + " مورد را انتخاب کنید";
            }, formatLoadMore: function () {
                return"فراخوانی نتایج بیشتر...";
