...
public class LogControllerTest extends AbstractContextControllerTests {

    ////////////////////
    private final String _PANEL_URL = "/panel/log";
    ...
    public void pListTest_accessTo() throws Exception {
        ...
        this.mockMvc
                ...
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(view().name(TtTile___.p_sys_log_list.getCode()))
                .andExpect(model().hasNoErrors())
    ...
    public void pDetailsTest_accessTo() throws Exception {
        ...
        Log realLog = MockObjectInstances.getInstance().getRealLog();

        //----------------------- LogManager
        this.signinAsLogManager();
        this.mockMvc
                .perform(
                        get(_PANEL_URL + "/details/" + realLog.getId())
                                .session(session)
                                .accept(MediaType.TEXT_HTML)
                )
                .andDo(print())
                ...
                .andExpect(view().name(TtTile___.p_e_401.getCode()))
                .andExpect(model().hasNoErrors())
                .andExpect(model().attributeDoesNotExist("log"))
        ;
        ...
        this.mockMvc
                ...
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(view().name(TtTile___.p_sys_log_details.getCode()))
                .andExpect(model().hasNoErrors())
 ...
 //#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=#=##=# pBackupTestsddTest  #
    //============================= pBackupTestsddTest_accessTo  #
@Test
    public void pBackupTestsddTest_accessTo() throws Exception {
        //--- EMPTY_TEST 
