...
public class LayerShareControllerTest extends AbstractContextControllerTests {
    ...
    public void pListTest_accessTo() throws Exception {
        ...
        this.mockMvc
                ...
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(view().name(TtTile___.p_service_layer_list.getCode()))
                .andExpect(model().hasNoErrors())
    ...
    public void pCreateTest_accessTo() throws Exception {
        ...
        this.mockMvc
                ...
                .andExpect(view().name(TtTile___.p_e_401.getCode()))
                .andExpect(model().hasNoErrors())
                .andExpect(model().attributeDoesNotExist("layer", "action"))
        ;
        ...
        this.mockMvc
                ...
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(view().name(TtTile___.p_service_layer_create.getCode()))
                .andExpect(model().hasNoErrors())
                .andExpect(model().attributeExists("layer", "action"))
        ;
    }
    //............................. pCreateTest_accessTo  #
    ...
    public void pCreateTest_post_submit() throws Exception {
        Layer objLayer = MockObjectInstances.getInstance().getLayer(true);

        //----------------------- Check Access
        this.mockMvc
                .perform(
                        MockObjectBuilder
                                .postForm(_PANEL_URL + "/create", objLayer)
                                .session(session)
                )
                .andDo(print())
                .andExpect(status().isOk())
    ...
    public void pEditTest_accessTo() throws Exception {
        ...
        Layer realLayer = MockObjectInstances.getInstance().getRealLayer();

        //----------------------- LogManager
        this.signinAsLogManager();
        this.mockMvc
                .perform(
                        get(_PANEL_URL + "/edit/" + realLayer.getId())
                                .session(session)
                                .accept(MediaType.TEXT_HTML)
                )
                .andDo(print())
        ...
        this.mockMvc
                ...
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(view().name(TtTile___.p_service_layer_edit.getCode()))
                .andExpect(model().hasNoErrors())
                .andExpect(model().attributeExists("layer", "action"))
        ;
    }
    ...
    public void pEditTest_post_submit() throws Exception {
        ...
        this.mockMvc
                .perform(
                        MockObjectBuilder
                                .postForm(_PANEL_URL + "/edit", MockObjectInstances.getInstance().getLayer(true))
                                .session(session)
                )
                .andDo(print())
                .andExpect(status().isOk())
        ...
        this.mockMvc
                .perform(
                        MockObjectBuilder
                                .postForm(_PANEL_URL + "/edit", realLayer)
                                .session(session)
                )
                .andDo(print())
                .andExpect(status().isFound())
        ...
        this.mockMvc
                ...
                .andDo(print())
                .andExpect(status().isFound())
                .andExpect(flash().attributeExists("notice", "layer"))
        ;
    }
    //............................. pEditTest_post_submit  #
    ...
    public void pTrashTest_ajax_do() throws Exception {
        ...
        MvcResult mvcResult = this.mockMvc
                .perform(
                        MockObjectBuilder
                                .postForm(_PANEL_URL + "/create", MockObjectInstances.getInstance().getLayer(true))
                                .session(session)
                )
                .andDo(print())
                .andExpect(status().isFound())
