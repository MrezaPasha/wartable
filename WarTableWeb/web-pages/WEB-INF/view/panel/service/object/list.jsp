...
<div class="container c-list-container">
    <div class="page-header">
        <div class="cred-header">
            ...
            <h3 class="cred-title"><spring:message code="object.list"/></h3>
            <a href="${_url}/create" class="btn btn-p-create btn-animated btn-animated-right">
                <i class="clip-plus-circle light"></i>
                <span class="title"><spring:message code="object.create"/></span>
            </a>
        </div>
    </div>
    <div class="row">
                        ...
                        <div i-search-template-body class="margin-b-10 c-search-list table-responsive">
                            <table>
                                ...
                                <tr style="display: none">
                                    ...
                                    <td class="center">
                                        <div class="r-button">
                                            <a href="${_url}/preview/@{id}"
                                               class="btn btn-sm btn-l-preview tooltips " data-placement="top"
                                               data-original-title="<spring:message code="T.p.service.object.preview"/> ">
