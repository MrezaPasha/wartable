!function (a) {
    ...
    var b = navigator.appVersion.indexOf("Mac") > -1, c = navigator.userAgent.indexOf("MSIE") > -1, d = function () {
        ...
        return{isText: q, isPara: c, isList: f, isEditable: g, isControlSizing: h, isAnchor: b("A"), isDiv: b("DIV"), isSpan: b("SPAN"), isB: b("B"), isU: b("U"), isS: b("S"), isI: b("I"), isImg: b("IMG"), ancestor: i, listAncestor: j, listNext: n, listPrev: m, commonAncestor: k, listBetween: l, insertAfter: o, position: s, makeOffsetPath: t, fromOffsetPath: u, split: w, remove: x}
    }(), g = function () {
        ...
        var c = new j, d = new k, e = new l, g = new m, h = new n, i = {BACKSPACE: 8, TAB: 9, ENTER: 13, SPACE: 32, NUM0: 48, NUM1: 49, NUM6: 54, NUM7: 55, NUM8: 56, B: 66, E: 69, I: 73, J: 74, K: 75, L: 76, R: 82, S: 83, U: 85, Y: 89, Z: 90, SLASH: 191, LEFTBRACKET: 219, BACKSLACH: 220, RIGHTBRACKET: 221}, o = function (b) {
            ...
            if (f.isControlSizing(b.target)) {
                ...
                l.on("mousemove", function (a) {
                    d = {x: a.clientX - p.left, y: a.clientY - (p.top - q)}, c.resizeTo(d, n), g.update(i, {image: m}), e.update(j, {image: m})
                }).on("mouseup", function () {
            ...
            var j = {c: Math.ceil(c.x / A) || 1, r: Math.ceil(c.y / A) || 1};
        ...
        }, n = [["#000000", "#424242", "#636363", "#9C9C94", "#CEC6CE", "#EFEFEF", "#EFF7F7", "#FFFFFF"], ["#FF0000", "#FF9C00", "#FFFF00", "#00FF00", "#00FFFF", "#0000FF", "#9C00FF", "#FF00FF"], ["#F7C6CE", "#FFE7CE", "#FFEFC6", "#D6EFD6", "#CEDEE7", "#CEE7F7", "#D6D6E7", "#E7D6DE"], ["#E79C9C", "#FFC69C", "#FFE79C", "#B5D6A5", "#A5C6CE", "#9CC6EF", "#B5A5D6", "#D6A5BD"], ["#E76363", "#F7AD6B", "#FFD663", "#94BD7B", "#73A5AD", "#6BADDE", "#8C7BC6", "#C67BA5"], ["#CE0000", "#E79439", "#EFC631", "#6BA54A", "#4A7B8C", "#3984C6", "#634AA5", "#A54A7B"], ["#9C0000", "#B56308", "#BD9400", "#397B21", "#104A5A", "#085294", "#311873", "#731842"], ["#630000", "#7B3900", "#846300", "#295218", "#083139", "#003163", "#21104A", "#4A1031"]], o = function (b) {
            b.find(".note-color-palette").each(function () {
                for (var b = a(this), c = b.attr("data-target-event"), d = "", e = 0, f = n.length; f > e; e++) {
                    for (var g = n[e], h = "<div>", i = 0, j = g.length; j > i; i++) {
        ...
        this.createLayout = function (b, f, g, h) {
            if (!b.next().hasClass("note-editor")) {
                var j = a('<div class="note-editor"></div>');
                f > 0 && a('<div class="note-statusbar"><div class="note-resizebar"><div class="note-icon-bar"></div><div class="note-icon-bar"></div><div class="note-icon-bar"></div></div></div>').prependTo(j);
                var k = a('<div class="note-editable" contentEditable="true"></div>').prependTo(j);
                f && k.height(f), g && k.data("tabsize", g), k.html(b.html()), k.data("NoteHistory", new i);
                for (var n = "", p = 0, q = h.length; q > p; p++) {
                    var r = h[p];
                    n += '<div class="note-' + r[0] + ' btn-group">';
                    for (var s = 0, t = r[1].length; t > s; s++)
                        n += c[r[1][s]];
                    n += "</div>"
                }
                n = '<div class="note-toolbar btn-toolbar">' + n + "</div>";
                var u = a(n).prependTo(j);
                o(u), m(u, "bottom");
                var v = a(d).prependTo(j);
                m(v), a(e).prependTo(j), a(l).prependTo(j), j.insertAfter(b), b.hide()
            }
        };
        var p = this.layoutInfoFromHolder = function (a) {
            var b = a.next();
            if (b.hasClass("note-editor"))
                return{editor: b, toolbar: b.find(".note-toolbar"), editable: b.find(".note-editable"), statusbar: b.find(".note-statusbar"), popover: b.find(".note-popover"), handle: b.find(".note-handle"), dialog: b.find(".note-dialog")}
        };
    ...
    a.fn.extend({summernote: function (b) {
            if (b = a.extend({toolbar: [["style", ["style"]], ["font", ["bold", "italic", "underline", "clear"]], ["fontsize", ["fontsize"]], ["color", ["color"]], ["para", ["ul", "ol", "paragraph"]], ["height", ["height"]], ["table", ["table"]], ["insert", ["link", "picture"]], ["fullscreen", ["fullscreen"]], ["help", ["help"]]]}, b), this.each(function (c, d) {
                var e = a(d);
