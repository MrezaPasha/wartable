...
<div class="container c-list-container">
    <div class="page-header">
        <div class="cred-header">
            <h3 class="cred-title"><spring:message code="T.p.service.startupNotice.list"/></h3>
            <a href="${_url}/create" class="btn btn-p-create btn-animated btn-animated-right">
                <i class="clip-plus-circle light"></i>
                <span class="title"><spring:message code="T.p.service.startupNotice.create"/></span>
            </a>
        </div>
    </div>
    <div class="row">
                            ...
                            <table>
                                ...
                                <tr style="display: none">
                                    ...
                                    <td class="center">
                                        <div class="r-button">
                                            <a
                                                    href="${_url}/item/list/@{id}"
                                                    class="btn btn-sm btn-l-assign" data-placement="top"
                                                    title="<spring:message code="T.p.service.startupNotice.item.list"/> ">
