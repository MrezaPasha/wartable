...
CKEDITOR.plugins.setLang("a11yhelp", "km", {
    ...
    legend: [{
        ...
        items: [{
            ...
            }, {name: "ប្រអប់បញ្ជីអ្នកកែសម្រួល", legend: "Inside a list-box, move to next list item with TAB OR DOWN ARROW. Move to previous list item with SHIFT+TAB or UP ARROW. Press SPACE or ENTER to select the list option. Press ESC to close the list-box."},
