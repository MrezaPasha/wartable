...
<div class="container" style="min-height: 300px;">
    <div class="page-header">
        <div class="cred-header">
            <h3 class="cred-title"><spring:message code="user.list.inactive" /></h3>
            <a href="${cp}/panel/user/deactivate" class="btn btn-p-close btn-animated btn-animated-right">
                <i class="clip-exit light"></i>
                <span class="title"><spring:message code="user.deactivate" /></span>
            </a>
        </div>
    </div>
    <div class="row">
        <div ir-search-id="adv1" ir-search-url="${cp}/panel/user/list/inactive" ir-search-auto-submit="true"
             class="lix-container">
