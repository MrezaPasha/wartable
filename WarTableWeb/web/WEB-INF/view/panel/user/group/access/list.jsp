            ...
            <div class="well well-act" >
                <ul class="disabled-li margin-bottom xs-center-ul">
                    <li class="tooltips" data-original-title="<spring:message  code="all.choice"/>" data-placement="bottom">
                        <a  href="${cp}/panel/user/group/access/list/0" class="btn btn-default btn-block btn-act">
                    ...
                    <li class="tooltips" data-original-title=" <spring:message code="all.reload"/>" data-placement="bottom">
                        <a href="${cp}/panel/user/group/access/list/${userGroup.id}" class="btn btn-default btn-block btn-act">
