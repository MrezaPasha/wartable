...
public class BaseErrorsShareControllerTest extends AbstractContextControllerTests {
    ...
    public void pListTest_accessTo() throws Exception {
        ...
        this.mockMvc
                ...
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(view().name(TtTile___.p_service_baseErrors_list.getCode()))
                .andExpect(model().hasNoErrors())
    ...
    public void pEditTest_accessTo() throws Exception {
        ...
        BaseErrors realBaseErrors = MockObjectInstances.getInstance().getRealBaseErrors();

        //----------------------- LogManager
        this.signinAsLogManager();
        this.mockMvc
                .perform(
                        get(_PANEL_URL + "/edit/" + realBaseErrors.getId())
                                .session(session)
                                .accept(MediaType.TEXT_HTML)
                )
                .andDo(print())
                ...
                .andExpect(view().name(TtTile___.p_e_401.getCode()))
                .andExpect(model().hasNoErrors())
                .andExpect(model().attributeDoesNotExist("baseErrors", "action"))
        ;
        ...
        this.mockMvc
                ...
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(view().name(TtTile___.p_service_baseErrors_edit.getCode()))
                .andExpect(model().hasNoErrors())
                .andExpect(model().attributeExists("baseErrors", "action"))
        ;
    }
    //............................. pEditTest_accessTo  #
    ...
    public void pEditTest_post_submit() throws Exception {
        ...
        this.mockMvc
                .perform(
                        MockObjectBuilder
                                .postForm(_PANEL_URL + "/edit", MockObjectInstances.getInstance().getBaseErrors(true))
                                .session(session)
                )
                .andDo(print())
                .andExpect(status().isOk())
        ...
        this.mockMvc
                .perform(
                        MockObjectBuilder
                                .postForm(_PANEL_URL + "/edit", realBaseErrors)
                                .session(session)
                )
                .andDo(print())
        ...
        this.mockMvc
                ...
                .andDo(print())
                .andExpect(status().isFound())
                .andExpect(flash().attributeExists("notice", "baseErrors"))
        ;
    }
    //............................. pEditTest_post_submit  #
