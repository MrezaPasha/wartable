...
//#########******#######// StaticFields: End //
    ...
    public String getTitleAndModuleTitle() {
        return SpringMessager.get(messageCode.substring(0, messageCode.lastIndexOf("."))) + " | " + SpringMessager.get(messageCode);
    }
