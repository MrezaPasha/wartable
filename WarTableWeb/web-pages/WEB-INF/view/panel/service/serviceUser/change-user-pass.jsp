...
<div class="container">
    <h3 class="cred-header">
        <span class="cred-title"><spring:message code="serviceUser.change.password"/></span>
        ...
        <div class="well well-act">
            ...
            <ul class="disabled-li margin-bottom xs-center-ul-4">
                <li class="tooltips" data-original-title="<spring:message code="all.edit"/>" data-placement="bottom">
                    <a href="${_url}/edit/${serviceUser.id}" class="btn btn-default btn-block btn-act">
                ...
                <div id="pwd-container" class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <c:set var="varName" value="serviceUser.password.new"/>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <c:set var="varName" value="serviceUser.repassword"/>
