...
<div class="container" style="min-height: 300px;">
    <div class="page-header">
        <div class="cred-header">
            ...
            <h3 class="cred-title"><spring:message code="note.list"/></h3>
            <a href="${cp}/panel/note/create" class="btn btn-p-create btn-animated btn-animated-right">
                <i class="clip-plus-circle light"></i>
                <span class="title"><spring:message code="note.create"/></span>
            </a>
        </div>
    </div>
    <div class="row">
        <div ir-search-id="adv1" ir-search-url="${cp}/panel/note/list" ir-search-auto-submit="true"
             class="lix-container">
                                ...
                                <tr ir-search-body-item>
                                    ...
                                    <td class="center">
                                        <div class="r-button">
                                            ...
                                            <a ir-search-action-trash="@{id}" data-title="@{title}" data-back=""
